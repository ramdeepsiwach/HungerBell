...
import com.se_p2.hungerbell.Adapter.MyCustomMarkerAdapter;
import com.se_p2.hungerbell.Common.Common;
import com.se_p2.hungerbell.Model.ShippingOrderModel;
import com.se_p2.hungerbell.Remote.IGoogleAPI;
import com.se_p2.hungerbell.Remote.RetrofitGoogleClient;
...
public class TrackingOrderActivity extends FragmentActivity implements OnMapReadyCallback, ValueEventListener {
            ...
            Dexter.withActivity(this)
                    ...
                    .withListener(new PermissionListener() {
                        ...
                        public void onPermissionDenied(PermissionDeniedResponse permissionDeniedResponse) {
                            Toast.makeText(TrackingOrderActivity.this, "You must enable call permission.", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void drawRoutes() {
        LatLng orderLocation = new LatLng(Common.currentShippingOrder.getOrderModel().getLat(),
                Common.currentShippingOrder.getOrderModel().getLng());

        LatLng shipperLocation = new LatLng(Common.currentShippingOrder.getCurrentLat(),
        ...
        if (shipperMarker == null) {
            ...
            shipperMarker = mMap.addMarker(new MarkerOptions()
                    ...
                    .snippet(new StringBuilder().append(Common.currentShippingOrder.getShipperPhone())
                            .append("\nEstimate Time:").append(Common.currentShippingOrder.getEstimateTime()).toString())
        ...
        String to = new StringBuilder()
                ...
                .append(",").append(Common.currentShippingOrder.getOrderModel().getLng())
                .toString();
